...
class ToolBarRing extends ShadowElement {
    ...
    constructor(session) {
        ...
        this.ringIconSvg.createChild("defs", {
            content: `<filter id="my-filter" width="10000" height="10000" x = "-5000" y = "-5000">
            <feMorphology operator="erode" radius="2" result="erode" in="SourceGraphic"></feMorphology>
        <feComposite  operator="arithmetic" k2="1" k3 = "-1" result="outline" in="SourceGraphic" in2="erode"></feComposite>
        <feMorphology operator="dilate" radius="2" result="dilate" in="outline"></feMorphology>
        <feOffset dx="0.5" dy="0.5" result="bor" in="dilate"></feOffset>
        <feGaussianBlur stdDeviation="10" result="blur" in="bor"></feGaussianBlur>
        <feComposite  operator="in" result="crop" in2="blur" in="SourceGraphic"></feComposite>
        <feComposite  operator="arithmetic" k2="1" k3 ="0.5" result="mer" in2="crop" in="SourceGraphic"></feComposite>
